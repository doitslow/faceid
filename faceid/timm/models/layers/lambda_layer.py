...
class LambdaLayer(nn.Module):
    ...
    The internal dimensions of the lambda faceid are controlled via the interaction of several arguments.
    ...
    Args:
        ...
        stride (int): output stride of the faceid, avg pool used if stride == 2
