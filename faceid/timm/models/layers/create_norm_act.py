...
Create norm + act combo layer that attempt to be backwards compatible with separate norm + act
isntances in model. Where these are used it will be possible to swap separate BN + act layers with
combined layer like IABN or EvoNorms.
