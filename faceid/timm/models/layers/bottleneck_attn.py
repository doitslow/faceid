...
class BottleneckAttn(nn.Module):
    ...
    The internal dimensions of the attention faceid are controlled by the interaction of several arguments.
      * the output dimension of the faceid is specified by dim_out, which falls back to input dim if not set
    ...
    Args:
        dim (int): input dimension to the faceid
        dim_out (int): output dimension of the faceid, same as dim if not set
        stride (int): output stride of the faceid, avg pool used if stride == 2 (default: 1).
